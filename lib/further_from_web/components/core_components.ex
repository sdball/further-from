defmodule FurtherFromWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FurtherFromWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FurtherFromWeb.Gettext, "errors", msg, opts)
    end
  end
